  ...
  const {deck, 
    ...
    const Column2Elements = gameCards.Columns[1].map((Card: card, index: number) => {
      ...
      if(gameCards.Columns[1].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[1].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
    ...
    const C = Card.value
      ...
      if(gameCards.Columns[2].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[2].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
    ...
    const C = Card.value
      ...
      if(gameCards.Columns[3].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[3].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
    ...
    const C = Card.value
      ...
      if(gameCards.Columns[4].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[4].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
    ...
    const C = Card.value
      ...
      if(gameCards.Columns[5].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[5].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
    ...
    const C = Card.value
      ...
      if(gameCards.Columns[6].length < 8){
        ...
        style = `${style} ${styles.largeCard}`
      } else if(gameCards.Columns[6].length > 13){
        style = `${style} ${styles.smallCard}`
      }
      if(!!Card.shown){
        if(C === 1){
